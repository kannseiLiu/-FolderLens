...
- Keep duplicate estimates conservative by excluding symbolic links, requiring stable filesystem identity, and counting hard-linked paths to the same file identity once.
